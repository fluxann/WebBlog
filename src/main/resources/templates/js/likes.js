var clicksLike = 0;
var hasClicked_Like = false;
var clicksDislike = 0;
var hasClicked_Dislike = false;

function onLike(element) {
  console.log(hasClicked_Like, hasClicked_Dislike)
  if (!hasClicked_Like) {
    if (hasClicked_Dislike) {
      clicksDislike -= 1;
      element.nextElementSibling.querySelector("#Dislike").innerText = clicksDislike;
      hasClicked_Dislike = false;
    }
    clicksLike += 1;
    element.querySelector("#Like").innerText = clicksLike;
    hasClicked_Like = true;
  } else if (hasClicked_Like) {
    clicksLike -= 1;
    element.querySelector("#Like").innerText = clicksLike;
    hasClicked_Like = false;
  }
}

function onDislike(element) {
  if (!hasClicked_Dislike) {
    if (hasClicked_Like) {
      clicksLike -= 1;
      element.previousElementSibling.querySelector("#Like").innerText = clicksDislike;
      hasClicked_Like = false;
    }
    clicksDislike += 1;
    element.querySelector("#Dislike").innerText = clicksDislike;
    hasClicked_Dislike = true;
  } else if (hasClicked_Dislike) {
    clicksDislike -= 1;
    element.querySelector("#Dislike").innerText = clicksDislike;
    hasClicked_Dislike = false;
  }
